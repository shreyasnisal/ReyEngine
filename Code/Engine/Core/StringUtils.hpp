...
int SplitStringOnDelimiter(Strings& out_splitStrings, std::string const& originalString, char delimiterToSplitOn, char characterToTokenizeOn, bool removeCharacterToTokenizeOn = true);
